...
#     # Check if the message type is a minute bar
#     if data.get('T') == 'b':
#         print(f"Minute Bar - Time: {data['t']}, Symbol: {data['S']}, Open: {data['o']}, High: {data['h']}, Low: {data['l']}, Close: {data['c']}, Volume: {data['v']}")
...
#     auth_message = {
#         "action": "auth",
#         "key": 'PKPRG8K0NWPZF8OVAD6D',
#         "secret": '3GIthGaocQkYhn0SmmIg2ZDErsUoLnwFpU6BQSBO'
#     }
#     ws.send(json.dumps(auth_message))
    
#     # Subscribe to Bitcoin minute bars after a short delay to ensure authentication completes
...
if __name__ == "__main__":
    websocket_url = "wss://wspap.okx.com:8443/ws/v5/business?brokerId=9999"
